...
# experiment_03/fingerprint/preprocessing.py -> parents[1] == experiment_03/.
DEFAULT_MODEL_PATH = Path(__file__).resolve().parents[1] / "models" / "czech-pdt-ud-2.5-191206.udpipe"
    ...
    def __init__(self, model_path: Optional[Path] = None):
        ...
        if not model_path.exists():
            raise FileNotFoundError(
                ...
                f"Download from https://lindat.mff.cuni.cz/repository/xmlui/handle/11234/1-3131 "
